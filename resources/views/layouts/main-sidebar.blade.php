<!-- main-sidebar -->
		...
		<aside class="app-sidebar sidebar-scroll">
			...
			<div class="main-sidemenu">
				...
				<ul class="side-menu">
					<li class="side-item side-item-category">Invoices Application</li>
					<li class="slide">
                    ...
                    @can('invoices')
                        ...
                        <li class="slide">
                            ...
                            <ul class="slide-menu">
                                @can('invoice-list')
                                    <li><a class="slide-item" href="{{ url('/' . $page='invoices') }}">Invoice Lists</a></li>
                                @endcan
                                @can('paid-invoice')
                                ...
                                @endcan
                                @can('partial-invoice')
                                    <li><a class="slide-item" href="{{ url('/' . $page='invoice_partial') }}">Partial Paid Invoices</a></li>
                                @endcan
					...
					<li class="slide">
						...
						<ul class="slide-menu">
                            @can('user-list')
							<li><a class="slide-item" href="{{ url('/' . $page='users') }}">user Lists</a></li>
                            @endcan
                            @can('user-accessability')
							<li><a class="slide-item" href="{{ url('/' . $page='roles') }}">User Accessabilties</a></li>
                            @endcan
						</ul>
					</li>
                    @endcan
